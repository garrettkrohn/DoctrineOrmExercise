 ...
 */
final class Version20230421185303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (user_id INT NOT NULL, role_id INT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(user_id))');
